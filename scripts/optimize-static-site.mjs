...
function processHtml(relativePath) {
  ...
  const replacements = [
    ...
    [
      ...
      '.nav{padding:0 18px}.nav-logo{min-width:auto;justify-content:flex-start}.nav-logo img{height:68px;transform:translate(-44px,16px)}.nav-logo::after{bottom:-18px;transform:translateX(112px);width:52px;height:14px}',
    ],
    [
