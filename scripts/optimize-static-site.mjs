...
function processHtml(relativePath) {
  ...
  const replacements = [
    ...
    [
      ...
      '.nav{padding:0 18px}.nav-logo{min-width:auto}.nav-logo img{height:72px;transform:translateY(3px)}.nav-logo::after{bottom:-10px;width:52px;height:14px}',
    ],
    [
