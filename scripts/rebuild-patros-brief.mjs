...
:root{
  ...
  --muted:#637086;
  --off:#f7fafc;
  --shadow:0 18px 42px rgba(22,45,73,.08);
  --radius:14px;
  --header-h:96px;
}
...
.search-panel{position:absolute;top:calc(100% + 12px);right:0;width:min(400px,calc(100vw - 32px));padding:14px;border:1px solid #b9c8d8;border-radius:16px;background:rgba(255,255,255,.98);box-shadow:0 28px 54px rgba(19,43,70,.16);opacity:0;transform:translateY(8px);pointer-events:none;transition:.18s ease}
...
.search-panel input{width:100%;border:1px solid #bcc9d8;border-radius:12px;padding:12px 14px;font-size:15px;outline:none;color:var(--navy);background:#fff}
.search-panel input:focus{border-color:#7fb685;box-shadow:0 0 0 4px rgba(45,122,45,.08)}
...
.hero-grid{display:grid;grid-template-columns:1.06fr .94fr;gap:0;overflow:hidden;border-bottom:1px solid var(--border);background:#fff}
.hero-copy{position:relative;padding:78px 64px 66px;background:#fff;border-right:1px solid var(--border)}
...
.lead{max-width:700px;font-size:18px;line-height:1.86;color:var(--muted)}
...
.service-card{display:flex;flex-direction:column;gap:14px;padding:26px 24px;border-radius:14px;background:#fff;border:1px solid var(--border);box-shadow:0 8px 20px rgba(19,43,70,.04);transition:.2s ease}
...
.spotlight{display:grid;grid-template-columns:minmax(0,1.05fr) 220px;gap:26px;align-items:stretch;margin-top:22px;padding:26px;border-radius:16px;background:linear-gradient(135deg,#163454 0%,#1c3a5c 100%);color:#fff;box-shadow:var(--shadow)}
...
.panel{padding:34px;border-radius:16px;background:#fff;border:1px solid var(--border);box-shadow:0 8px 20px rgba(19,43,70,.04)}
.home-copy{padding:12px 0 0}
.home-copy h2{margin:0 0 16px;font-size:clamp(30px,4vw,44px);line-height:1.08;color:var(--navy);letter-spacing:-.04em}
.home-copy p{margin:0 0 14px;font-size:17px;line-height:1.85;color:var(--muted);max-width:780px}
.stats-band{background:var(--navy);border-top:1px solid rgba(255,255,255,.04);border-bottom:1px solid rgba(17,38,62,.08)}
.stats-band-inner{display:grid;grid-template-columns:repeat(4,1fr)}
.stats-chip{padding:28px 26px;border-right:1px solid rgba(255,255,255,.08);text-align:center}
.stats-chip:last-child{border-right:none}
.stats-chip strong{display:block;font-size:38px;line-height:1;color:#7fd07f}
.stats-chip span{display:block;margin-top:8px;font-size:12px;letter-spacing:.12em;text-transform:uppercase;color:rgba(255,255,255,.6)}
    ...
    body: `
      <main>
        <section class="hero">
          <div class="shell hero-grid">
            <div class="hero-copy">
              ...
              <p class="lead" data-sk="Energetická efektívnosť a inžinierske činnosti na slovenskom a českom trhu od roku 2013. Pomáhame klientom identifikovať rezervy, lepšie rozhodovať o investíciách a pretaviť energetické dáta do reálnych úspor aj výkonu." data-en="Energy efficiency and engineering services on the Slovak and Czech market since 2013. We help clients identify reserves, make better investment decisions and turn energy data into measurable savings and performance.">Energetická efektívnosť a inžinierske činnosti na slovenskom a českom trhu od roku 2013. Pomáhame klientom identifikovať rezervy, lepšie rozhodovať o investíciách a pretaviť energetické dáta do reálnych úspor aj výkonu.</p>
        ...
        <section class="stats-band">
          <div class="shell stats-band-inner">
            <div class="stats-chip fade"><strong>6</strong><span data-sk="Oblasti služieb" data-en="Service areas">Oblasti služieb</span></div>
            <div class="stats-chip fade"><strong>10+</strong><span data-sk="Rokov skúseností" data-en="Years of experience">Rokov skúseností</span></div>
            <div class="stats-chip fade"><strong>ISO</strong><span data-sk="50001 · 14001" data-en="50001 · 14001">50001 · 14001</span></div>
            <div class="stats-chip fade"><strong>SK+CZ</strong><span data-sk="Aktívne trhy" data-en="Active markets">Aktívne trhy</span></div>
          </div>
        </section>
        ...
        <section class="section">
          <div class="shell feature-split">
            <div class="home-copy fade">
              <p class="eyebrow" data-sk="O nás" data-en="About us">O nás</p>
              <h2 data-sk="Patros Roll na slovenskom a českom trhu od roku 2013" data-en="Patros Roll on the Slovak and Czech market since 2013">Patros Roll na slovenskom a českom trhu od roku 2013</h2>
              <p data-sk="Vitajte na webovej stránke spoločnosti Patros Roll s.r.o. V oblasti energetiky na slovenskom a českom trhu aktívne pôsobíme od roku 2013. V tomto smere je našou nosnou činnosťou energetická efektívnosť a inžinierske činnosti, ktoré s ňou priamo súvisia." data-en="Welcome to the website of Patros Roll s.r.o. We have been actively operating in energy on the Slovak and Czech market since 2013. Our core focus is energy efficiency and the engineering activities directly related to it.">Vitajte na webovej stránke spoločnosti Patros Roll s.r.o. V oblasti energetiky na slovenskom a českom trhu aktívne pôsobíme od roku 2013. V tomto smere je našou nosnou činnosťou energetická efektívnosť a inžinierske činnosti, ktoré s ňou priamo súvisia.</p>
              <p data-sk="Energetika je dôležitou súčasťou fungovania každého štátu aj väčšiny podnikateľských činností. Zodpovedný prístup k efektívnemu využívaniu energií výrazne podporuje ekonomickú výkonnosť a konkurencieschopnosť. Preto sa prostredníctvom našich služieb snažíme dopomôcť zákazníkom k dosahovaniu ich plánov a cieľov." data-en="Energy is an important part of every state's functioning and most business activities. A responsible approach to efficient energy use strongly supports economic performance and competitiveness, which is why our services help clients reach their plans and goals.">Energetika je dôležitou súčasťou fungovania každého štátu aj väčšiny podnikateľských činností. Zodpovedný prístup k efektívnemu využívaniu energií výrazne podporuje ekonomickú výkonnosť a konkurencieschopnosť. Preto sa prostredníctvom našich služieb snažíme dopomôcť zákazníkom k dosahovaniu ich plánov a cieľov.</p>
